      ...
      <div className="col-span-3 mx-5">
        ...
        {hasPrime && (
            <div className="flex items-center space-x-2">
                <img loading="lazy" className=" flex w-14" src="https://images-na.ssl-images-amazon.com/images/G/01/prime/delivery-landingpage/prime_logo_new._V524737024_.jpg" alt="Has Prime" />

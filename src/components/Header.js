        ...
        <header>
            ...
            <div className='flex items-center bg-amazon_blue p-1 flex-grow py-2'>
                ...
                <div className='text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap'>
                    ...
                    <div className='link relative hover:underline flex items-center'>
                        <span className='absolute top-0 right-0 md:right-4 h-4 w-4 bg-yellow-400 text-center rounded-full text-black font-bold'>0</span>
